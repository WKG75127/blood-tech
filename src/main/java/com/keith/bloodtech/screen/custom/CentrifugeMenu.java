package com.keith.bloodtech.screen.custom;
...
public class CentrifugeMenu extends AbstractContainerMenu {
    ...
    public CentrifugeMenu(int containerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory,1, 99, 27));
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory,2, 117, 27));
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory,3, 99, 45));
        this.addSlot(new SlotItemHandler(this.blockEntity.inventory,4, 117, 45));
        addDataSlots(data);
}
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.CENTRIFUGE_BLOCK.get());
    }
